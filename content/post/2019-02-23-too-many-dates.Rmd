...
This was copied-and-pasted from the BBC website, because I was too lazy to figure out how to do it better. 
...
```{r}
games %>% mutate(the_date=dmy(str_c(X1, " ", 2018))) -> d
```
...
games %>% filter(str_detect(X1, pat)) %>% 
  mutate(date_of=dmy(str_c(X1, " ", 2018))) -> lookup
lookup
```
